package com.calypso.general.datastructures.williamfisset;
...
import com.calypso.general.datastructures.pi.SparseMatrix;

public class BellmanFordAdjacencySparseMatrix {
   ...
   */
  public BellmanFordAdjacencySparseMatrix(int start, double[][] matrix) {
  ...
  public static void main(String[] args) {
    ...
    * graph[0][1] = 0.7236;
    ...
    int start = 0;
    BellmanFordAdjacencySparseMatrix solver;
    solver = new BellmanFordAdjacencySparseMatrix(start, graph);
